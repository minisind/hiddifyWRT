...
func (e *HiddifyWRT) GetUI() ui.Form {
...
func (e *HiddifyWRT) setFormData(data map[string]string) error {
...
func (e *HiddifyWRT) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "hiddifyWRT",
		Description: "Awesome Extension hiddifywrt created by minisind",
		Fields: [][]ui.FormField{
			{{
...
func (e *HiddifyWRT) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "hiddifyWRT",
		Description: "Awesome Extension hiddifywrt created by minisind",
...
func (e *HiddifyWRT) addAndUpdateConsole(message ...any) {
